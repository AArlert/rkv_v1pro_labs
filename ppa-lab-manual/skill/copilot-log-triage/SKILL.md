...
outputs:
  - PASS/FAIL 统计
  - 每条 FAIL 的：TC 名 / 错误类型 / 关键行号 / 建议 fix_request 模板
tools:
  - Read, Grep
---
...
|---|---|---|---|
| TC1 | PASS | — | — |
| TC5 | FAIL | mismatch | PSLVERR expected 1 got 0 @ 235ns → FR-NNNN |
| TC8 | FAIL | timeout | done_o 未拉高 in 10us，看 FSM 是否卡 PROCESS |

## Suggested fix_requests
- FR-NNNN: ...
```
...
- 不替我做 fix；只提示
- 同类错误聚合（10 个 TC 都因为同一个 RTL bug 挂 → 1 个 FR）
